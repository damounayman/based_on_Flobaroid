...
class Optimizer(object):
    ...
    def getLinkDistance(self, l0_name, l1_name, joint_q):
        ...
        o0 = fcl.CollisionObject(b0, Transform(rot0, pos0+b0_center))
        o1 = fcl.CollisionObject(b1, Transform(rot1, pos1+b1_center))

        #distance, d_result = fcl.distance(o0, o1, collision_data.DistanceRequest(True))
        distance = fcl.distance(o0, o1, collision_data.DistanceRequest(True))
        if distance < 0:
            ...
            collisionNb = fcl.collide(o0, o1, cr, c_result)
